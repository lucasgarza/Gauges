...
void gaugePSI() {
  u8g.setFont(u8g_font_courB24);
    ...
    u8g.drawStr( 75, 40, psi);
     //u8g.drawStr( 75, 40, "55");
...
//  psi1 = ((sensorVal-102.4)*100)/785;
  ...
  psi1 = sensorVal; //reads value from input pin and assigns to variable
  psi1 = ((psi1-pressureZero)*pressuretransducermaxPSI)/(pressureMax-pressureZero); //conversion equation to convert analog reading to psi
  Serial.print(psi1, 1); //prints value from previous line to serial
