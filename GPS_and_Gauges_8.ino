...
void gauge(uint8_t angle) {
 ...
 // w = 8;
if (w>=.8 && w<=6){
   u8g.drawLine(xcenter, ycenter, 15, 20);
}else if (w>=6 && w<=9){
 u8g.drawLine(xcenter, ycenter, 30, 18);

}else if (w>=9 && w<=11){
 u8g.drawLine(xcenter, ycenter, 45, 8);
}else{
  u8g.drawLine(xcenter, ycenter, xcenter+arc*x1, ycenter-arc*y1);
}
  ...
  u8g.drawStr( 20, 42, "0");                  
  u8g.drawStr( 25, 18, "8");
  u8g.drawStr( 60, 14, "12");
  u8g.drawStr( 95, 18, "18");
  u8g.drawStr( 105, 42, "24");

  // show gauge label
  u8g.setFont(u8g_font_profont22);  
  u8g.setPrintPos(labelXpos[3],60);            
  u8g.print(label[3]);
...
void gaugeSpeed() {
  ...
  u8g.drawStr( 10, 60, speed);
  //u8g.undoScale();
  u8g.setFont(u8g_font_fur11);
  u8g.drawStr( 60, 12, satsBuf);
}
...
void gaugePSI() {
  u8g.setFont(u8g_font_courB24);
   ...
   // u8g.setFont(u8g_font_unifont);
    u8g.drawStr( 0, 60, psi);
     //u8g.drawStr( 0, 40, "Hello World!");
  u8g.setFont(u8g_font_fur11);
  u8g.drawStr( 70, 60, "PSI");

  
   u8g.drawFrame (0,10,120,20); // create an empty rectangle (frame) with the values ​​(x, y, width, height) 
   u8g.drawBox (10,15, psi1, 10); 

  // u8g.drawBitmapP( 70, 60, 6, 8, oil);
...
void displayInfo()
{
  if (gps.speed.isUpdated())
  {
   ...
   // Serial.print(gps.speed.value());
    ...
    dtostrf(speed1, 6, 2,speed); // Leave room for too large numbers!
